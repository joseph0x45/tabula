<script lang="ts" >
    ...
    import { clear, add_task } from "../../store/board";
...
<main class=" fixed top-0 right-0 bg-transparent p-2 " >
    
    <div class="flex justify-between items-center w-min gap-5 h-min" >
       
        <button class=" hover:cursor-not-allowed " disabled title="Coming soon" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                <path d="M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1.43-.333.604-.903.408-1.41a7.002 7.002 0 00-13.074.003z" />
            </svg>      
        </button>
        <button disabled title="Coming soon" class=" hover:cursor-not-allowed" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
        ...
        <button title="Add Task" on:click={toggle_show_modal} >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
            </svg>          
        </button>
        <button on:click={clear} class=" hover:text-red-600" title="Clear board" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
