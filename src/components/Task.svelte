...
<main style={`background-color:${task.color.primary}; left: ${task.posx}px; top: ${task.posy}px; `} class={` select-none text-white w-52 h-min rounded-xl shadow-2xl p-2 absolute `} >
    <section 
